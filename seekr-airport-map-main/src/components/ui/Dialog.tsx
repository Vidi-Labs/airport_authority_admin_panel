...
export function DialogHeader({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex items-center shrink-0 p-5 pb-1 text-slate-900 text-2xl font-semibold leading-snug center">
      {children}
    </div>
  );
}
...
export function DialogBody({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative p-5 pt-3 text-slate-600 text-base font-light leading-relaxed">
      {children}
    </div>
  );
}
